...
<body>
    ...
    <%-- Adım 1 : Result div'ine doğrudan server tarafında random bir sayı göndermek istiyorum. Bu random sayı Page Load olduğunda result div'inde görülecek. --%>
    ...
    <%-- Adım 2 : Page Load'da değil de, bir button'un click event'inde random bir sayı üretilsin. --%>
        ...
        <%--  server'da çalışan özel eventler lazım--%>
        <%--  code behind'de ise windowsForm'daki gibi event'ın çalıştıracağı methodlar yazılır. --%>
    ...
    <%-- Adım 4 : Bir loto senaryosu üzerine 6 adet random sayı talep edicem. Her butona tıklandığında bir random sayı ve yanında kaç adet random sayı taletp edildiğini gösteren sayaç olacak. Sayaç 6 olduğunda random sayı yerine "Bitti" yazılacak. --%>

        <%-- [[[STATELESS ]]]: (Durumsuz) Durumunu koruyamayan: Her talep yeni bir page demektir. Haliyle her yeni page içerisinde tanımlanan global değişkenler tekrardan tanımlanır. --%>
